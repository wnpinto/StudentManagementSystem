	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addPurchaseButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				bills = (RadioButton)findViewById(R.id.billsRb);
				entertainment = (RadioButton)findViewById(R.id.entertainmentRb);
				groceries = (RadioButton)findViewById(R.id.groceriesRb);
				...
				purchasesDatasource.createNewPurchace(storeInput.getText().toString(), productInput.getText().toString(), priceInput.getText().toString(), category);
				//purchasesDatasource.open();
				//purchasesDatasource.createNewPurchace(storeInput.getText().toString(), productInput.getText().toString(), priceInput.getText().toString(), "other");
