...
public class RecentPurchacesSQLDatasource {
	...
	private String[] columns = {RecentPurchacesSQLContract.COLUMN_NAME_STORE, RecentPurchacesSQLContract.COLUMN_NAME_ITEM, 
			RecentPurchacesSQLContract.COLUMN_NAME_PRICE, RecentPurchacesSQLContract.COLUMN_NAME_CATEGORY};
	...
	public String[] readData(){
		...
		cursor.moveToFirst();
		String[] c = {cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3)};
		cursor.close();
		this.close();
		return c;
	}
